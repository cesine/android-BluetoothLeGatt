 ...
 */
public class DeviceOthersScanActivity extends ListActivity {
...
//                        Log.d(TAG, "偵測到 BLE: "+ scanRecord);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle(R.string.title_devices_non_ibeacon);
...
// http://stackoverflow.com/questions/22016224/ble-obtain-uuid-encoded-in-advertising-packet
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = DeviceOthersScanActivity.this.getLayoutInflater();
        }
