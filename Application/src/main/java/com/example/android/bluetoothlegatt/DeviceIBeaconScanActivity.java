 ...
 */
public class DeviceIBeaconScanActivity extends ListActivity {
...
//                        Log.d(TAG, "偵測到 BLE: "+ scanRecord);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle(R.string.title_devices_ibeacon);
...
// http://stackoverflow.com/questions/22016224/ble-obtain-uuid-encoded-in-advertising-packet
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = DeviceIBeaconScanActivity.this.getLayoutInflater();
        }
